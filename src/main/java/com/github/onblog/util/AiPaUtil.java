...
/**
 * Create by Martin 2018/9/27/027 20:26
 */
public class AiPaUtil {
    ...
    public AiPaUtil(Charset charset, Map<String, String> header, Connection.Method method, Integer timeout, String userAgent, Map<String, String> cookies) {
